        ...
        <form id="edit-event-form" action={updateEvent} className="space-y-4">
          ...
          <ThemeSection color="indigo" title="Gruppen- & Vereins-Features">
            ...
            <div>
              ...
              <input id="eventPin" type="text" name="eventPin" defaultValue={event.eventPin || ''} className={`w-full border ${themeClasses('indigo').border} p-2 rounded outline-none ${themeClasses('indigo').borderFocus}`} placeholder="z.B. Sommer26 (leer lassen für öffentliches Event)" />
