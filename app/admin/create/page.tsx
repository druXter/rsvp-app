        ...
        <form action={createEvent} className="space-y-4">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-200 bg-purple-50 p-4 rounded-md">
            ...
            <div>
              ...
              <input type="text" name="eventPin" className="w-full border border-purple-300 p-2 rounded outline-none focus:border-purple-500" placeholder="z.B. Sommer26 (leer lassen für öffentliches Event)" />
