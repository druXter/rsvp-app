...
// Diese Seite liest die echten Angaben zur Laufzeit aus der (nicht versionierten) .env -
// im Repository bleiben dadurch nur Platzhalter sichtbar. Erzwingt dynamisches Rendering,
// damit die Werte bei jedem Aufruf frisch aus process.env gelesen werden, statt beim
// Docker-Build (wo noch keine echte .env vorliegt) einmalig als statische HTML gebacken zu werden.
